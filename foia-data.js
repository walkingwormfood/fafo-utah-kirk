      ...
      requests: [
        {
          ...
          ask_no_records: true,
          filed: "INVOICED — filed Jul 16, 2026, 1:10 p.m. by email to the Governor's records officer (Adam Duncan, aduncan@utah.gov). Response Jul 17, 2026: EXPEDITE DENIED and FEE WAIVER DENIED, same public-benefit finding as the courtyard request (§ 63G-2-204(4)(a); 'unclear how you intend to use records' / how the Utah public accesses the publication). Prepayment required before any processing: invoice No. 260716AB2 / GO-071726-0088 = $540 (9.0 hrs staff time @ $60) + $75 out-of-state filing fee = $615.00, due Aug 3, 2026. Fee-waiver-denial OVERRIDE available to CAO Jon Pierpont (jonpierpont@utah.gov) within 5 business days of the denial (~Jul 27, 2026, accounting for Pioneer Day Jul 24). DO NOT PREPAY pending an override decision. Response .eml + invoice PDF archived to gdrive."
        }
      ]
    },
    {
