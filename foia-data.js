...
const FOIA = {
  ...
  agencies: [
    ...
    { id: "atfagency", name: "Bureau of Alcohol, Tobacco, Firearms and Explosives", email: null, fed: true,
      portal: "https://www.atf.gov/resource-center/freedom-information-act-foia",
      submitNote: "ATF now takes FOIA ONLY through its own FOIA PAL portal — linked from atf.gov/resource-center/freedom-information-act-foia — and no longer accepts email (verified Jul 2026). This button opens that page; click through to the PAL portal, create the account it asks for, and paste the request text into the description field (the portal collects your name, address, and fee preference in its own fields). Requester Service Center: 202-648-8740. Expect Exemption 7(A) claims while the related prosecution is pending; the written denial still fixes what records exist." },
    { id: "dod", name: "U.S. Department of Defense (OSD / Joint Staff — WHS)", email: null, fed: true,
      ...
      submitNote: "This button opens the OSD/Joint Staff FOIA Requester Service Center's submit page at Washington Headquarters Services (esd.whs.mil/FOID/Submit-Request) — the right component for records held by the Office of the Secretary of Defense and Joint Staff, which covers both of this case's DoD asks (OSD strategic-communications contracting and DoD public-affairs activity). Paste the request text into its form. If a record turns out to belong to a different DoD component (e.g., Department of the Army), WHS will refer it, or file that component directly via FOIA.gov." },
