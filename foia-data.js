      ...
      requests: [
        {
          ...
          ask_no_records: true,
          filed: "PENDING — FILED Aug 7, 2026, 1:47 p.m. CT by email to uvpdrecords@uvu.edu. 10-business-day clock → due ~Aug 21. The vendor contract is a standing public record whatever happens to the investigation items; if no preservation hold exists, that written confirmation is the finding."
        },
        {
          agencyId: "orem",
      ...
      requests: [
        {
          ...
          ask_no_records: true,
          filed: "PENDING — FILED Aug 7, 2026, 1:55 p.m. CT by email to uvpdrecords@uvu.edu. 10-business-day clock → due ~Aug 21. Item (2) is the sharp end: a tagged rifle on video either has a property entry or it does not."
        }
      ]
    },
    {
      ...
      requests: [
        {
          ...
          ask_no_records: true,
          filed: "PENDING — FILED Aug 7, 2026, 1:56 p.m. CT by email to uvpdrecords@uvu.edu; preservation ask rode with it (Sept 9 video flagged for routine-overwrite risk). 10-business-day clock → due ~Aug 21. Expect the § 63G-2-106 categorical wall on the video item (as raised on #26-229/#26-230) — the field-interview and log items are the core ask and are ordinary police paper."
        }
      ]
    },
    {
