...
const FOIA = {
  ...
  agencies: [
    ...
    { id: "slcda", name: "Salt Lake City Department of Airports (SLC Corp)", email: null,
      portal: "https://saltlakecityut.justfoia.com/publicportal/home/newrequest",
      submitNote: "ROUTE AUDITED Aug 12, 2026 — Salt Lake City migrated GRAMA intake to a JustFOIA portal (saltlakecityut.justfoia.com); the old slc.gov/recorder/grama page is a 404. The airport's own public-records page (slcairport.com/business-services/public-records) points at the same JustFOIA portal; phone backup 801-575-2470. Appeals go to the Mayor's Records Appeals Board via the City Recorder (451 South State Street Room 415, PO Box 145515, SLC UT 84114-5515) within 30 calendar days. The airport is a city department, so its landing reports and access logs are city records under GRAMA." },
  ...
  investigations: [
    {
      ...
      requests: [
        ...
        },
        {
          ...
          ask_no_records: true,
          filed: "PENDING — FILED Aug 7, 2026, 1:44 p.m. CT by email to recorder@provo.org (City Recorder — the non-police GRAMA lane). 10-business-day clock → due ~Aug 21. Small, dated, single-facility ask — the cheap, fast corner of the AXL10 triangle while the FAA and Army lanes grind."
        },
        {
          agencyId: "army",
    ...
    },
    {
      ...
      status: "confirmed",
      finding: "The lead investigator testified the ME report's front page recites investigative information that didn't come from his team — and on day four, the firearms examiner testified the medical examiner documented potentially SEVEN bullet fragments while she received FOUR, a discrepancy she learned of only \"a few months ago.\" New (Aug 11, from the Dorey Ep 459 sit-down, transcript banked): forensics expert Joseph Scott Morgan (40 yrs, ex-Atlanta ME senior investigator, co-author of the national medicolegal death-investigation standard), told the fragments arrived at the lab in a manila envelope with three missing: \"my question is where are the other three fragments? That's a reasonable question to ask\" — and adds the grain-weight check: fragments recovered should be weighed against the nominal projectile weight of the charged round; a large unexplained mass deficit is itself a finding. He also flags the transfer path: fragments recovered at autopsy are photographed on the table, packaged per-fragment with the decedent's accession number, and transmitted by documented handoff — precisely the paperwork this card's request targets.",
      ...
      sources: [
        ...
        { label: "Dorey Ep 459, Aug 2026 — Coleman x Joseph Scott Morgan: the manila envelope, the missing three, the grain-weight accounting, the per-fragment packaging standard (transcript banked in the library)", url: "https://youtu.be/4KcNRwNntcs" },
        { label: "Rio Gates part 3 — the examiner's 7-vs-4 testimony walked through against the exhibit photos (transcript banked in the library)", url: "https://www.youtube.com/live/V7a6e_fBF98" }
      ],
      requests: [
        {
          agencyId: "ome",
    ...
    },
    {
      ...
      sources: [
        ...
        { label: "Dorey Ep 459, Aug 2026 — JSM on the body's chain: pronounced ~1:40 p.m., Erika reports the body still warm at ~4:00, departure on news footage at 7:57 p.m., transported by a state contractor; on the 3+ hour hospital hold: \"chain of custody issue? It's a major problem\"; embalmed, casketed, and in Arizona ~24 hours post-death — the timeline the body-custody/transport-log request (item 4) exists to document (transcript banked in the library)", url: "https://youtu.be/4KcNRwNntcs" }
      ],
      requests: [
        {
          agencyId: "ome",
    ...
    },
    {
      ...
      requests: [
        ...
        },
        {
          ...
          ask_no_records: true,
          filed: "NO RECORDS Aug 11, 2026 — Werner (county attorney's office, letter banked in foia-mail/results): 'there was no internal or independent investigation done in this incident, therefore there are no records to provide.' That answer collides with the separation agreement the same office released the same day: recital B says the County 'has received allegations of misconduct,' and ¶2 pays $100,000 partly in exchange for the County refraining 'from any further investigation into the allegations' — a paid-for promise not to investigate an investigation the county now says never existed. Werner's letter also mentions 'I have a statement from Washington County' that was not attached — picked up as item 3 of the ¶6 follow-up request below."
        },
        {
          agencyId: "washco",
          summary: "Washington County — the ¶6 follow-up: circumstances of separation, the allegations paper, the missing 'statement,' and the $100k approval trail",
          subject: "GRAMA Request: records detailing the circumstances leading to former Sheriff Brooksby's separation (per ¶6 of the March 2026 Separation Agreement)",
          records: "Four items, each anchored in the County's own released agreement: (1) records detailing the circumstances leading to Brooksby's separation — the category ¶6 ('Open Record Requirements') of the agreement itself names; (2) the records by which the County 'received allegations of misconduct' per Recital B — complaint, intake, referral memo, or transmitting correspondence (witness statements excluded); (3) the 'statement from Washington County' Werner described but did not enclose in her Aug 11 letter; (4) the Commission record approving the ¶2 $100,000 payment — agenda item, minutes, payment authorization, and the warrant/check of disbursement. With the ¶6 no-contractual-bar argument, the elected-official/public-funds balancing argument, the standing preservation demand, and per-item no-records confirmation with search description.",
          ask_no_records: true,
          filed: "PENDING — FILED Aug 11, 2026, ~12:35 p.m. CT by email to grama@washco.utah.gov + angela.werner@washco.utah.gov (reply in the thread that delivered the agreement, own subject line). Strategy credit: Dank's discord — use the county's own ¶6 as the lever. 10-business-day clock → due ~Aug 25."
        }
      ]
    },
    {
      ...
      requests: [
        {
          ...
          ask_no_records: true,
          filed: "PENDING — FILED Aug 7, 2026, 1:47 p.m. CT by email to ncis_foia@ncis.navy.mil (Attn: FOIA, Code 00LJF, Quantico). 20-business-day federal clock → due ~Sep 4. The Richmond IG records are Virginia FOIA — citizens-only — and stay parked until a Virginia-resident requester exists."
        }
      ]
    },
    {
      ...
      requests: [
        {
          ...
          ask_no_records: true,
          filed: "PENDING — FILED Aug 7, 2026, 1:47 p.m. CT by email to uvpdrecords@uvu.edu; assigned NextRequest #26-283, formal acknowledgment Aug 11 + EXPEDITE DENIED on the standard § 63G-2-204(4)(a) failed-to-meet-that-burden public-benefit finding → due ~Aug 21. The vendor contract is a standing public record whatever happens to the investigation items; if no preservation hold exists, that written confirmation is the finding."
        },
        {
          agencyId: "orem",
          ...
          ask_no_records: true,
          filed: "PENDING — FILED Aug 7, 2026, 1:48 p.m. CT by email to records@orem.gov; the immediate-preservation demand is in the request text. 10-business-day clock → due ~Aug 21 — but expect Orem's UCAO compelled-classification letter (it denied the K9 and hospital-lockdown asks Aug 6 with it); a § 305(10) claim over a NETWORK AUDIT LOG and a retention policy would be the blanket hold at its most categorical, and the denial letter itself feeds the UCAO card."
        },
        {
          agencyId: "provo",
      ...
      requests: [
        {
          ...
          ask_no_records: true,
          filed: "PENDING — FILED Aug 4, 2026 via SecureRelease (DHS → United States Secret Service); acknowledged same day as FOIA File Number 2026-USSSFOIA-01703. Formal written acknowledgment letter Aug 11 (FOIA Program Communications Center, Washington DC) restating the full request text — NSSE designation or SEAR level for the Sept 21, 2025 State Farm Stadium memorial, plus lead-agency records — with the expedite determination still pending under the DHS compelling-need standard. FOIA Public Liaison: Kevin Tyrrell, (202) 220-1819; FOIA@usss.dhs.gov."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      sources: [
        ...
        { label: "Owens Ep 374, Aug 2026 (transcript banked): the state's own timeline has the return-trip vehicle stop \"making contact with an officer doing security detail\" — named as Officer GOFORTH — with no footage or bodycam of that contact ever produced; a discrete bodycam/CAD ask once the officer's agency is identified", url: "https://www.youtube.com/live/5zgkrOaCCj4" },
      ...
      requests: [
        {
          ...
          ask_no_records: true,
          filed: "PENDING — FILED Aug 7, 2026, 1:54 p.m. CT by email to ucao@utahcounty.gov. 10-business-day clock → due ~Aug 21. The office’s own notice invites the ask: correspondence ABOUT restricting records is not itself a restricted investigative record — and this request makes the blanket-hold's paper trail itself the record."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      requests: [
        ...
        },
        {
          ...
          ask_no_records: true,
          filed: "PENDING — filed Jul 12, 2026, 2:51 p.m. via NextRequest, request #26-2791 (Utah County). Extraordinary circumstances claimed twice: Jul 29 (§ 204(6)(d), +10 business days → Aug 11) and Aug 11 (+5 business days → due Aug 18). But the Aug 11 notice concedes the central fact: 'There are numerous body worn camera video files associated with this investigation/case. Without a specific officer's name, staff is having to sort through the files to determine which officer's camera recorded the requested footage.' No § 305(10) invoked — Utah County is PROCESSING, and has confirmed in writing that responsive BWC footage exists in volume. Open move: a one-line portal reply naming the recovering officer from the preliminary-hearing record would strip the remaining delay rationale. (Original notes: confirmation on submission; no invoice; photo-ID applies only to subject-of-record requests.)"
        },
        {
          agencyId: "uvupd",
      ...
      requests: [
        {
          ...
          ask_no_records: true,
          filed: "PENDING — FILED Aug 7, 2026, 1:55 p.m. CT by email to uvpdrecords@uvu.edu; assigned NextRequest #26-282, formal acknowledgment Aug 7 (request text quoted back, 10-business-day recital) → due ~Aug 21. Item (2) is the sharp end: a tagged rifle on video either has a property entry or it does not."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      status: "contested",
      finding: "The state's courtroom video compilations contain undisclosed edits, verifiable from the on-screen timestamps: a missing 1:16 in the 11:53 a.m. clip (11:53:17 → 11:54:33), stairwell cuts spliced out of chronological order (11:56:00–:24, :25–:59, then :01–:04), and a 55-minute garage gap (8:29 arrival, 9:24 stairwell) presented as continuous. New (Aug 11, transcripts banked): stills from the 4K courtroom footage now circulating show the garage figure putting his phone in his LEFT hand and an earpiece in his LEFT ear (Owens Ep 374: \"government source feels confident this person is left-handed\" — Robinson takes notes right-handed in court), and a build Coleman reads as 40-50 lbs heavier than Robinson (\"that picture right there is not guilty\"). A viewer catch Coleman confirmed: on Jul 31 the stairwell camera was exhibited labeled as two different levels with an identical background. Coleman's on-air demand, naming SBI, the Utah County Attorney's Office, Judge Graff, and the defense: release ALL campus surveillance, indoor and outdoor, 8:00 a.m.–1:30 p.m., unedited and un-enhanced — and he notes police bodycam is routinely released pre-trial in contested-shooting cases.",
    ...
    {
      id: "uvu-tpusa-anniversary-comms",
      challenge: "UVU reversed and stonewalled TPUSA on the one-year memorial — and these communications have no criminal case to hide behind.",
      short: "The anniversary stonewall",
      categories: ["Institutional behavior"],
      entities: ["uvu-ent", "tpusa"],
      investigator: "Baron Coleman (Ep 157)",
      investigatorLinks: [
        { label: "Coleman Ep 157, Aug 2026 — the cancellation and the direct GRAMA solicitation (transcript banked in the library)", url: "https://www.youtube.com/live/g5JGPL5pxVM" }
      ],
      status: "reported",
      finding: "Per Coleman's sourcing: TPUSA sought to hold a one-year commemorative service on the ground where Kirk was killed; UVU \"suddenly reversed and began stonewalling communications\" with TPUSA's national leadership, and the anniversary event was canceled (UVU announced a campus closure with employees paid, pointing attendees to a United Way service day in Provo instead). Coleman's on-air ask, verbatim in spirit: \"This would be a great [GRAMA] to file because there's no criminal case involved... I would love to see what these communications were like... UVU has gotten so many from me, I'm afraid they see my name and put it on hold.\"",
      implication: "Unlike the Sept 10 records, UVU cannot park these behind § 63G-2-305(10) — there is no investigation to protect. The 2026 planning and reversal correspondence is ordinary administrative record. If UVU stonewalls the memorial-planning file too, that pattern is itself the finding: an institution using litigation exemptions where none apply.",
      sources: [
        { label: "Coleman Ep 157 (transcript banked in the library)", url: "https://www.youtube.com/live/g5JGPL5pxVM" }
      ],
      requests: [
        {
          agencyId: "uvu",
          summary: "UVU — the 2026 communications with TPUSA about the anniversary event",
          subject: "GRAMA Request: communications concerning the September 2026 commemorative event proposed by Turning Point USA",
          records: "I request, for the period May 1, 2026 through the date this request is processed: (1) communications between Utah Valley University (including the President's office, University Relations, Facilities, and UVU PD) and Turning Point USA or its representatives concerning a proposed September 2026 commemorative or anniversary event on campus; (2) internal UVU records documenting the decision to approve, deny, or decline that event, including the stated reasons; and (3) the record announcing or documenting the September 10, 2026 campus closure decision. This request concerns 2026 event planning only — not the 2025 incident or any investigation. Please also retain this correspondence and all records related to the processing of this request. If no responsive record exists for any numbered item, I request written confirmation of that fact for that item, including a description of the search conducted.",
          ask_no_records: true,
          filed: "NOT FILED — DRAFTED Aug 11, 2026, ready for NextRequest. Solicited on-air by Coleman precisely because his own UVU requests risk name-recognition slow-walking; the 2026-only scoping denies UVU its § 305(10) and § 106 reflexes."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      investigatorLinks: [
        ...
        { label: "Rio Gates part 3, Aug 2026 (transcript banked): the examiner fired SIX test rounds (two required); individual markings present but \"so much deviation... she couldn't make a determination\"; testified to dust in the barrel, origin unexplored; the two ammo boxes recovered from the house were never counted or variety-identified on the record", url: "https://www.youtube.com/live/V7a6e_fBF98" },
      ...
      requests: [
        {
          ...
          ask_no_records: true,
          filed: "PENDING — FILED Aug 7, 2026, 1:56 p.m. CT by email to uvpdrecords@uvu.edu; assigned NextRequest #26-281, formal acknowledgment Aug 7 (request text quoted back in full, 10-business-day recital) → due ~Aug 21. Preservation ask rode with it (Sept 9 video flagged for routine-overwrite risk). Expect the § 63G-2-106 categorical wall on the video item (as raised on #26-229/#26-230) — the field-interview and log items are the core ask and are ordinary police paper."
        }
      ]
    },
    {
