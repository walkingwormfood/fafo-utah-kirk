...
- **A denial still counts.** There's a pending capital prosecution; anything evidentiary draws a § 63G-2-305 protected-records claim. GRAMA requires the denial to be written and cite the exact provision (§ 63G-2-205) — the withholding itself goes on paper, and it's appealable (§ 63G-2-401: 30 days to the entity's chief administrative officer, then the State Records Committee).
